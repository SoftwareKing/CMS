  ...
  <div id="warp">
    ...
    <div class="right">
      <div class="right_bt">
        <div>
         <span>当前您的位置&nbsp;
           <a href="<%=request.getContextPath()%>/index">首页</a><span style="color:#F7CA0F">|标签检索:${con }</span>
		</span>
        </div>
      ...
      <div class="right_nr">
          <div id="channel_right">
                <div id="channel_title">
					<span>检索内容:[${con }]——检索标签:</span>
					<span>
						<input type="text" id="keyword" value="${con }"/><input type="button" id="keyword_btn" value="进行检索"/>
				   </span>
				</div>
				<table>
