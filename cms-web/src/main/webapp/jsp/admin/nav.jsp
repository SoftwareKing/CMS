...
<c:if test="${isAdmin }">
	<ul class="navMenu navSelected">
		<h3 class="navTitle">
			<span class="navTilteTxt">学院相关管理</span>
		</h3>
		<li class="navChild">
			<a href="<%=request.getContextPath() %>/admin/department/departments" target="content">学院各系管理</a>
		</li>
		<li class="navChild">
			<a href="<%=request.getContextPath() %>/admin/people/peoples" target="content">学院人员管理</a>
		</li>
